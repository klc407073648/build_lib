...
#include "StiBel/Data/Redis/CErrorMsg.h"
...
public:
	...
	CMyRedis();
	~CMyRedis();
	void Connect(const string& strIp="127.0.0.1",int nPort=6379,const string& passwd="");	
	bool CheckConenct();
	
	static CMyRedis::ptr getInstance(const string& strIp="127.0.0.1",int nPort=6379,const string& passwd="");
