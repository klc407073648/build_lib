...
#define STIBEL_DECLARE_EXCEPTION_CODE(CLS, BASE, CODE)                              \
	...
	public:                                                                         \
		...
		CLS(const std::string &msg, const StiBel::Common::Foundation::Exception &exc, int code = CODE); \
		CLS(const CLS &exc);                                                        \
		~CLS() noexcept;                                                            \
		CLS &operator=(const CLS &exc);                                             \
		const char *name() const noexcept;                                          \
		const char *className() const noexcept;                                     \
		StiBel::Common::Foundation::Exception *clone() const;                                           \
		void rethrow() const;                                                       \
	};
...
#define STIBEL_IMPLEMENT_EXCEPTION(CLS, BASE, NAME)                                                 \
	...
	CLS::CLS(const std::string &msg, const StiBel::Common::Foundation::Exception &exc, int code) : BASE(msg, exc, code) \
	{                                                                                               \
	}                                                                                               \
	...
	StiBel::Common::Foundation::Exception *CLS::clone() const                                                           \
	{                                                                                               \
		return new CLS(*this);                                                                      \
	}                                                                                               \
